    ...
    head: (
        <>
            ...
            <meta
                ...
                content="We design, so you can create! Wysteria UI provides a collection of reusable React components to help streamline the development of web applications."
            />
        </>
    ),
};
